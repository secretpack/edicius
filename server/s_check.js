...
const handlerWrapperArgs = { functionName: 'GroupCounseling-app-dev-check', timeout: 6 };

try {
  const userHandler = require('./apis/user/handler.js');
  module.exports.handler = serverlessSDK.handler(userHandler.check, handlerWrapperArgs);
} catch (error) {
